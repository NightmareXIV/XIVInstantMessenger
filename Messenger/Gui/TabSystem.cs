...
internal class TabSystem : Window
{
    ...
    internal IEnumerable<ChatWindow> Windows => P.WindowSystemChat.Windows.Cast<ChatWindow>().Where(x => (Name == null && !P.config.TabWindows.Contains(x.OwningTab)) || x.OwningTab == Name);
